...
const commander_1 = __importStar(__webpack_require__(2116));
const os_1 = __importDefault(__webpack_require__(857));
const path_1 = __importDefault(__webpack_require__(6928));
const exec_sh_1 = __importDefault(__webpack_require__(2155));
async function downloadVideo(url, downloadFilePath) {
    const args = {
        shell: false
    };
    await exec_sh_1.default.promise(["C:\\Users\\Matt\\Desktop\\Code\\TypeScript\\Repositories\\js-scripts\\bin\\youtube-dl.exe", "-o", downloadFilePath, url], args);
}
exports.downloadVideo = downloadVideo;
function createCli() {
    return commander_1.default.program
        .addArgument((0, commander_1.createArgument)("<url>", "URL of the video to download").argRequired())
        .addOption((0, commander_1.createOption)("-d, --directory <directory>", "Output directory.")
        .default(path_1.default.join(os_1.default.homedir(), "Downloads"), "Default to the user's download directory.")
        .makeOptionMandatory(false))
        .addOption((0, commander_1.createOption)("-f, --filename <filename>", "Defaults to the inferred file name from the download URL.").makeOptionMandatory(false))
        ...
        options.outputFilePath = path_1.default.join(options.directory, filename);
...
/******/ 	var __webpack_exports__ = __webpack_require__(3843);
